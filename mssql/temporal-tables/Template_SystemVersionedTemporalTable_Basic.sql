...
/* Run the following in a transaction to see that transaction start time is used for everything. Run it again outside of a transaction to see "normal" behavior over time. */
